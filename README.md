...
### Herkansing:
<details open>
  <summary>Het belangrijkste wat ik voor de herkansing moest doen was de code beter ordenen. Dat heb ik nu gedaan. De fonts, custom properties, header en footer staan nu in het basis css bestand. Verder heb ik nog twee pagina's de home pagina en de our_world pagina waar nu geen footers en headers etc. inzitten.<br>
    <img src="/readme-images/basiscssverandering.png" width="375px" alt="basis css"><br>
    Verder heb ik het hamburger menu compleet gemaakt, want dat was die nog niet.<br>
    <img src="/readme-images/hamburgermenunu.png" width="375px" alt="Hamburger menu">
    Daarnaast heb ik nog aan de responsiveness gewerkt van de website. Dit heb ik gedaan bij de home pagina en de our world pagina. Bij de onze wereld pagina was dat eerst niet het geval op de echte site. Maar nu wel, dus ik heb het proberen na te maken.<br>
    <img src="/readme-images/kleineversievankleding.png" width="375px" alt="op telefoon zie je de kleding in categorieën."><br>En op groot scherm.<br>
    <img src="/readme-images/groteversievankleding.png" width="375px" alt="op de computer zie je de kleding zo in categorieën."><br>
    Dan nu de schermen van onze wereld.
    <img src="/readme-images/kleinourworld.png"><br> width="375px" alt="onze wereld op telefoon."><br>
    <img src="/readme-images/grootourworld.png" width="375px" alt="onze wereld op laptop.">
  </summary>
</details>

## Toegankelijkheidstest herkansing
<detail open>
  <summary>
    Ik heb mijn html gevalideerd en die gaf 3 foutmeldingen aan bij het basis document. Ik had namelijk een translate gebruikt zonder haakjes en zonder er transform voor te zetten. Dit heb ik aangepast en toen waren al met documenten foutloos.<br>
    <img src="/readme-images/fouttranslate.png" width="375px" alt="Verkeerd gebruik van translate."><br>
    <img src="/readme-images/goedtranslate.png" width="375px" alt="Goed gebruik van translate."><br>
    Als taal heb ik gewoon Nederlands in gesteld met lang in beide html documenten.<br>
    De titel van de eerste pagina is gewoon Filling Pieces. En die van de tweede pagina is Filling Piecies onze wereld. Er wordt dus wel onderscheid tussen gemaakt.<br>
    Verder heb ik bijna voor alles een list gebruikt om bepaalde elementen te groeperen in de webpagina.<br>
    <img src="/readme-images/lists.png" width="375px" alt="De lijstjes in de code."><br>
    Ook heb ik op de foto van de footer een filter gegooid en daarmee de brightness omlaag gehaald zodat de letter en knop wat beter naar voren toekomen.<br>
    <img src="/readme-images/lichtaanpassing.png" width="375px" alt="Licht van foto vermindert."><br>
    Mijn site is ook toegankelijk voor mensen die kleurenblind zijn. Je kan dan nog alles zien qua verschil. De knoppen springen er echt uit dat komt omdat het contrast goed is. En er is een duidelijke font.<br>
    <img src="/readme-images/kleurenblind.png" width="375px" alt="Volledig kleurenblind."><br>
    <img src="/readme-images/roodslechtziend.png" width="375px" alt="Rode tinten."><br>
    <img src="/readme-images/groenslechtzien.png" width="375px" alt="Mensen die groene tinten zien."><br>
    Contrast
    <img src="/readme-images/contrast.png" width="375px" alt="Contrast bij een knop op mijn site."><br>
    Daarna heb ik nog wat testjes gedaan met de Voice Over.<br>
    <img src="/readme-images/menubalk.png" width="375px" alt="Testen met VoiceOver"><br>
    <img src="/readme-images/onzewereld.png" width="375px" alt="Voiceover onze wereld."><br>
  </summary>
</details>
...
<details open>
  ...
  7. https://developer.mozilla.org/en-US/docs/Web/CSS/transform-function/translate
</details>